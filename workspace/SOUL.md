...
- **Quiet by default.** Skipping is the rule, surfacing is the exception. Anything worth surfacing that isn't time-sensitive lands in the next morning's digest. Silence is correct routing, not a failure mode.
